...
db = MySQLdb.connect("127.0.0.1","root","1234","qpcm" )
cursor = db.cursor()
	...
	if(num_of_rows_family == 0):
		...
		for data in cursor.fetchall():
			...
			# print family_flag
				...
				some_sql_statement = "INSERT INTO `qpcmms_family` (member_id, dapendent_first_name1, dependent_family_name, dependent_sequence, relationship, dob, status, family_flag, time_flag) VALUES (%s, %s, %s, %s, %s, %s,'Active', %s, CURDATE())"
				cursor.execute(some_sql_statement, (id, dependent_first_name,dependent_family_name, dependent_sequence, relationship, date_of_birth, flag))
